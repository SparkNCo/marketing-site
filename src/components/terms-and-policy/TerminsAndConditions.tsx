    ...
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <div className="space-y-4 max-w-3xl ">
        ...
        <ul className="space-y-3 text-left">
          <li>
            1. Engage in any unlawful activity or promote any unlawful acts.
          </li>

          <li>
            2. Transmit any material that is defamatory, offensive, or otherwise
            objectionable.
          </li>

          <li>
            3. Use the Website in any way that causes, or may cause, damage to
            the Website or impairment of the availability or accessibility of
            the Website; or in any way which is unlawful, illegal, fraudulent,
            or harmful.
          </li>
          ...
          <li>
            ...
            harvesting) without our express written consent.
          </li>

          <li>
            5. Copy, store, host, transmit, send, use, publish, or distribute
            material containing spyware, computer viruses, Trojan horses, worms,
            keystroke loggers, rootkits, or other malicious software.
          </li>

          <li>
            6. Impersonate any person or entity, or falsely state or
            misrepresent your affiliation with a person or entity.
          </li>

          <li>
            7. Interfere with or disrupt the integrity or performance of the
            Website or the data contained therein.
          </li>
        </ul>
      </div>
    </section>
    ...
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <div className="space-y-4 max-w-3xl  leading-relaxed">
        <p>
          ...
          downloads, data compilations, and software, is the property of the
          Agency or its content suppliers and is protected by international
          copyright laws.
        </p>

        <p>
          <span className="font-semibold">B.</span> The Agency's trademarks and
          trade dress may not be used in connection with any product or service
          that is not the Agency's, in any manner that is likely to cause
          confusion among customers, or in any manner that disparages or
          discredits the Agency.
        </p>

        <p>
          <span className="font-semibold">C.</span> You are granted a limited,
          revocable, and non-exclusive right to create a hyperlink to the home
          page of the Website so long as the link does not portray the Agency,
  ...
  return (
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <p className="max-w-3xl  leading-relaxed">
        ...
        cause injury to any person or entity; and that you will indemnify the
        Agency for all claims resulting from content you supply.
      </p>
    </section>
  );
}
  ...
  return (
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <p className="max-w-3xl  leading-relaxed uppercase">
        ...
        AVAILABLE" BASIS, UNLESS OTHERWISE SPECIFIED IN WRITING. THE AGENCY
        ...
        OTHERWISE MADE AVAILABLE TO YOU THROUGH THE WEBSITE, UNLESS OTHERWISE
        SPECIFIED IN WRITING. YOU EXPRESSLY AGREE THAT YOUR USE OF THE WEBSITE
  ...
  return (
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <p className="max-w-3xl  leading-relaxed">
        ...
        conduct) by you or any other person accessing the Website using your
        Internet account.
      </p>
    </section>
  );
  ...
  return (
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <p className="max-w-3xl  leading-relaxed">
        ...
        Toronto, Ontario for the purpose of litigating all such claims or
        disputes.
      </p>
    </section>
  );
  ...
  return (
    <section className="bg-transparent text-background text-left space-y-6 px-4 py-10">
      ...
      <p className="max-w-3xl  leading-relaxed">
        ...
        severable and shall not affect the validity and enforceability of any
        remaining condition. Your continued use of the Website following the
