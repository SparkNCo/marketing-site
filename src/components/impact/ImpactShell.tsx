          ...
          <section className="mb-20">
            ...
            <div className="space-y-6 text-foreground">
              <p className="text-largeBody md:text-heading2 leading-relaxed">
                The Impact Program subsidizes our fees for qualifying
                projects that create meaningful social, community, educational,
              ...
              <div className="bg-foreground/5 border-l-4 border-primary p-6 rounded-r-lg">
                ...
                <p className="text-body leading-relaxed">
                  ...
                  please consider the following additional qualification points:
                </p>
              </div>
